...
echo "=========================================="
echo "🗑️ Безопасное удаление ресурсов диплома"
echo "=========================================="
...
# ⚠️ КРИТИЧЕСКИ ВАЖНО: Исключаем бакет из удаления перед выполнением destroy
...
echo "=========================================="
echo "💡 Ваш бакет 'dev-oll' и файл state в нем БЕЗОПАСНО СОХРАНЕНЫ."
echo "=========================================="
