...
- [workflows/deploy.yml](https://github.com/Ollrins/devops-diplom-yandexcloud/blob/main/.github/workflows/deploy.yml) - GitHub Actions workflow (build → push → deploy)
