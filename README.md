...
**Доступы к развёрнутым ресурсам:**

| Ресурс | URL | 
|--------|-----|
| **Grafana** | http://84.252.130.54/ | 
| **Тестовое приложение** | http://84.252.130.54/app 
...
- [.github/workflows/deploy.yml](https://github.com/Ollrins/devops-diplom-yandexcloud/tree/main/.github/workflows/deploy.yml) - GitHub Actions workflow (build → push → deploy)
